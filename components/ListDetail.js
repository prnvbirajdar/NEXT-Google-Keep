      ...
      >
        <div className="transition flex justify-between">
          {title === "" && body === "" ? (
            ...
            <p className="lg:tracking-wide break-all font-medium transition font-roboto text-base sm:text-sm md:text-sm lg:text-sm dark:text-offwhite ">
              {title}
            </p>
          )}
        </div>

        <p className="lg:tracking-wide transition pt-1 font-roboto text-base sm:text-sm md:text-sm lg:text-sm dark:text-offwhite">
          {body}
        </p>
      </div>
      <Modal
